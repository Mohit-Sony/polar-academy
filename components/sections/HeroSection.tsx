        ...
        <svg viewBox="0 0 500 500" fill="none" className="w-full h-full">
          ...
          <defs>
            <linearGradient id="yellow_grad" x1="0" y1="0" x2="500" y2="500" gradientUnits="userSpaceOnUse">
              ...
              <stop offset="1" stopColor="#D95405" />
            </linearGradient>
          </defs>
        </svg>
      </div>
      ...
      <div className="container-xl relative z-10 grid lg:grid-cols-2 gap-12 items-center flex-grow">
        ...
        <div className="max-w-xl">
          ...
          <div className="flex flex-wrap items-center gap-6 mb-16 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            ...
            <button className="flex items-center gap-2 text-white font-semibold hover:text-slate-300 transition-colors group">
              How it works
              <span className="flex items-center justify-center border border-white/60 rounded-[6px] px-1.5 py-1 group-hover:border-slate-300 transition-colors ml-1">
